...
class Connection(Base):
    ...
    # Optional environment label: "development" | "staging" | "production". Drives the colored
    # tiles on the Connections and Schemas pages. Non-secret, so it's a plain column.
